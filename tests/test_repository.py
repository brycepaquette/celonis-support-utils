...
def test_InMemoryTicketRepository_save_get_by_id(sample_salesforce_ticket, repo):
...
def test_InMemoryTicketRepository_list_open(sample_salesforce_ticket, repo):
    repo.save(sample_salesforce_ticket)
...
def test_InMemoryTicketRepository_unknown_ticket_id(sample_salesforce_ticket, repo):
    repo.save(sample_salesforce_ticket)
    assert repo.get_by_id("unknown_id") is None


def test_InMemoryTicketRepository_list_open_excludes_closed(
    sample_salesforce_ticket, repo
):
